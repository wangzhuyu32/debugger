...
namespace LeEcoDebugger
{
    public class T32
    {
        ...
        {
            string strCMD = string.Format("TITLE \"{1} {0}\"", cpuType.ToString(), T32_type.targetName);
        ...
        private int loadOS()
        {
            ...
            if (T32_type.subSystem.Equals("modem")) {
                string Task = Path.Combine(Application.StartupPath, "config\\qurt_model.t32");
                string menu = Path.Combine(Application.StartupPath, "config\\qurt_model.men");
